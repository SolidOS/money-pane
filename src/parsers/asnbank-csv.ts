import { WorldLedgerView, Balance, HalfTrade, ImportDetails, SettledPurchase, Shop, WorldLedgerMutation } from '../Ledger'
...
export function parseAsnbankCsv ({ fileBuffer, fileId }): WorldLedgerView {
  return parseGeneric({
    fileBuffer,
    fileId,
    parseLines,
